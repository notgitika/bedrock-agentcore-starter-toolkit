...
1. **Forbid Wins** - If any forbid policy matches, the result is DENY, even if permit policies also match
1. **At Least One Permit Required** - If at least one permit policy matches and no forbid policies do, the result is ALLOW
...
- ✓ Action check: Is the action RefundTool\_\_process_refund?
...
- [Policy Quickstart](https://aws.github.io/bedrock-agentcore-starter-toolkit/user-guide/policy/quickstart.html) - Get started with your first policy
- [Policy Integration Examples](https://aws.github.io/bedrock-agentcore-starter-toolkit/examples/policy-integration.html) - See real-world policy patterns
...
- [Gateway Integration Guide](https://aws.github.io/bedrock-agentcore-starter-toolkit/user-guide/gateway/quickstart.html)
